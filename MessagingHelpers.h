...
void init_proc_table(void);                         // TEST25 ADD CLEANUP
...
void prepare_blocked_sender(MsgProcEntry* me, int mboxId, void* pMsg, int msg_size);          // TEST25 ADD CLEANUP 
void prepare_blocked_receiver(MsgProcEntry* me, int mboxId, void* pMsg, int msg_size);        // TEST25 ADD CLEANUP 
int finish_blocked_call(MsgProcEntry* me, int result);                                        // TEST25 ADD CLEANUP 